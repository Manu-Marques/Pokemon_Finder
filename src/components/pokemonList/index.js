  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <input value={inputValue} onChange={fusionFonction} id="search" className=" w-full p-4 pl-10 text-xl text-gray-900 border border-4 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-70 dark:border-red-700 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pikachu, Dracaufeu ..." required />
